...
const DeleteArticleButton = ({articleId}:DeleteArticleButtonProps) => {
  ...
  return (
    <div onCanPlay={deleteArticleHandler} className="bg-red-600 text-white rounded-lg cursor-pointer inline-block text-center py-1 px-2 hover:bg-red-800 transition ">
    Delete
    </div>
  )
}
