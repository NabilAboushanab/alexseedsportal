...
const LoginForm = () => {
  ...
  return (
    <form onSubmit={formSubmitHandler} className="flex flex-col pt-4 ">
      <input
      ...
      />  
      <button disabled={loading} type="submit" className="text-2xl text-white bg-blue-600 p-2 rounded-lg font-bold">
