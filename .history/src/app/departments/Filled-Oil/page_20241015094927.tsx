...
const formattedDate = new Date(TradeMonth + 'T00:00:00Z');

await prisma.tblMSContractMain.create({
  data :{
    CtrNumM,CustNameEn, DDate: formattedDate,CustCode,ComType,
    CurrShNameEn,Premium,TradeMonth:formattedDate,
  }
});
redirect("/");
}
