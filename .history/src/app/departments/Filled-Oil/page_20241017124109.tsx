...
const Page: React.FC = () => {
  ...
  return (
    <div className="mt-6 mb-16 relative"> {/* جعل الحاوية نسبيّة لتسهيل وضع الزر */}
      <button
        onClick={toggleLanguage}
        className="absolute top-4 right-4 bg-green-600 hover:bg-green-400 transition-colors text-white font-bold rounded-lg text-lg mb-4" // استخدام الخصائص المطلوبه
      >
