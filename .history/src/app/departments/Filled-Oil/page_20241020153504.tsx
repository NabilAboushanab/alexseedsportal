...
const Button: React.FC<ButtonProps> = ({ href, label }) => (
  <Link
    href={href}
    className="bg-blue-600 hover:bg-blue-400 transition-colors text-white font-bold rounded-lg text-lg flex justify-center items-center w-64 h-20 mb-2" // تغيير h-16 إلى h-20
  >
    {label}
  </Link>
);
