...
const columns: Column[] = [
  {
    ...
    buttons: [{ href: "", label: { arabic: "صادر الميزان", english: "Export Balance" } }],
  },
  {
    ...
    buttons: [
      ...
      { href: "", label: { arabic: "حسابات العملاء", english: "Client Accounts" } },
    ],
  },
  {
...
const Page: React.FC = () => {
  ...
  return (
    <div className="mt-6 mb-16">
      <div className="flex justify-end mb-4"> {/* تنسيق لجعل الزر في الجهة اليمنى */}
        <button
          onClick={toggleLanguage}
          className="bg-green-600 hover:bg-green-400 transition-colors text-white font-bold rounded-lg text-sm h-12 px-4" // إضافة px-4 لزيادة المسافات الداخلية الأفقية
        >
