  ...
  return (
    <div className="mt-6 flex flex-col items-center">
      <Link
        ...
        className="bg-blue-600 hover:bg-blue-400 transition-colors text-white font-bold rounded-lg text-lg m-4 flex justify-center items-center w-400 max-w-md h-16"
      >
        Add New Contract
      </Link>
