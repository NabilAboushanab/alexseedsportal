...
<form action="">
  <input type="text"
   name="CtrNumber"
    ...
    className="mb-2 p-2 text-xl rounded-md text-gray-950 font-bold"
    />  
</form>
...
<form action="">
  <input type="text"
   name="CtrType"
    ...
    className="mb-2p-2 text-xl rounded-md text-gray-950 border-2 font-bold"
    />  
</form>
...
<form action="">
  <input type="text"
   name="Currency"
    ...
    className="p-2 text-xl rounded-md text-gray-950 border-2 font-bold"
    />  
</form>
