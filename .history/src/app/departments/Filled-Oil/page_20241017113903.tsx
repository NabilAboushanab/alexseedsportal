          ...
          {buttons
            ...
            .map((button, index) => (
              <Link
                key={index}
                href={button.href}
                className="bg-blue-600 hover:bg-blue-400 transition-colors text-white font-bold rounded-md text-md flex justify-center items-center w-40 h-12 mb-2 px-3" // استخدام عرض أقل
              >
                {button.label}
              </Link>
            ))}
