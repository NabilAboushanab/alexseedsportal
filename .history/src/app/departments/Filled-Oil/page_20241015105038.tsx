...
<input
   type="text"
    ...
    className="p-2 text-lg rounded-md text-gray-950 placeholder-blue-600
    "
     />
...
<input
    ...
    name="DDate"
    placeholder="Date"
    className="p-2 text-lg rounded-md text-gray-950"
     />
     ...
     <input
      ...
      className="p-2 text-lg rounded-md text-gray-950 resize-none"
     />
