...
import Button from '../../../components/Button'; // تعديل المسار هنا
import LanguageToggle from '../../../components/LanguageToggle'; // تعديل المسار هنا
import { useLanguage } from '../../../context/LanguageContext'; // تعديل المسار هنا
