...
import { TblFilledOil } from '@prisma/client';
...
interface FilledOilTableProps {
  searchParams: { pageNumber: string };
}

const TblFilledOil = async ({ searchParams: { pageNumber } }: TblFilledOilProps) => {

  try {
    const articles: TblFilledOil[] = await getArticles(pageNumber);
    ...
    return (
      <section className='p-5'>
            ...
            {articles.map((article) => (
              <tr key={article.id} className='border-b border-t border-gray-300'>
                ...
                <td>
                  ...
                  <DeleteTblFilledOilButton articleId={article.id}/>
                </td>
        ...
        {/* Pagination Component - Pass the required props */}
        <Pagination
