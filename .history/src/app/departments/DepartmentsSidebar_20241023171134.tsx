...
const DepartmentsSidebar = () => {
  return (
    <>
      {/* رابط للـ Dashboard */}
      <Link href="/departments/Filled-Oil" className="flex items-center text-lg lg:text-2xl font-semibold mb-6">
      ...
      <ul className="me-10 flex items-center justify-center flex-col lg:items-start">
        ...
        <Link
          className="flex items-center text-xl mb-5 lg:border-b border-gray-300 hover:border-yellow-200 hover:text-yellow-200 transition"
          href="/departments/          className="flex items-center text-xl mb-5 lg:border-b border-gray-300 hover:border-yellow-200 hover:text-yellow-200 transition"
          href="/departments/Filled-Oil""
        >
          <MdOutlineArticle className="me-1" />
