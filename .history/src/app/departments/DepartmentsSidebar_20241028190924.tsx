  ...
  return (
    <>
      ...
      <Link
        ...
        className="flex items-center w-full max-w-xs text-lg lg:text-2xl font-semibold mb-6"
      >
      ...
      <ul className="me-10 flex items-center justify-center flex-col lg:items-start max-w-xs">
        {/* رابط Filled Oil */}
        <Link
          className="flex items-center w-full max-w-xs text-1 mb-5 lg:border-b border-gray-300 hover:border-yellow-200 hover:text-yellow-200 transition"
          href="/departments/Filled-Oil"
        >
