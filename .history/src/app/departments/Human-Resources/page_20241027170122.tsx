...
const columns: Column[] = [
  {
    title: { arabic: "ال", english: "Management Instructions" },
    buttons: [{ href: "/departments/Human-Resources/AddDirections", label: { arabic: "تعليمات الادارة", english: "Management Instructions" } }],
  },
