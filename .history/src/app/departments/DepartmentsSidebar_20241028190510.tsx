...
const DepartmentsSidebar className="flex items-center text-lg lg:text-2xl font-semibold mb-6 w-px" = () => {
  return (
    <>
      {/* رابط للـ Dashboard */}
      <Link href="/departments/Filled-Oil" className="flex items-center text-lg lg:text-2xl font-semibold mb-6 w-px"
      >
