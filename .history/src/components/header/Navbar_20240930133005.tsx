...
<div className={styles.menu}>
 {toggle ? (<IoMdClose  onClick={() => setToggle(prev => !prev)} />) :  <AiOutlineMenu onClick={() => setToggle(prev => !prev)}/>}  
    ...
    <ul className={styles.navLinks}>
      ...
      <Link onClick={() => setToggle(false)} className={styles.navLink} href="/departments/Filled-Oil">
  Filled Oil
</Link>
<Link onClick={() => setToggle(false)} className={styles.navLink} href="/departments/sales-oil">
  Sales Oil
</Link>
