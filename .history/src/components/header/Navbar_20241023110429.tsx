      ...
      <nav className={styles.navbar}>
        ...
        <div className={`${styles.navLinkWrapper} ${toggle ? styles.openMenu : ''}`}>
          <ul className={styles.navLinks}>
            ...
            {/* Admin Section */}
            <li className={styles.navLink} onClick={() => setShowAdminSubmenu(!showAdminSubmenu)}>
            ...
            {/* Departments Section */}
            <li className={styles.navLink} onClick={() => setShowDepartmentsSubmenu(!showDepartmentsSubmenu)}>
              <Link href="/departments">Departments</Link>
              {showDepartmentsSubmenu && (
                <ul className={styles.submenu}>
                  <li className={styles.navLink} onClick={() => setShowFilledOilSubmenu(!showFilledOilSubmenu)}>
