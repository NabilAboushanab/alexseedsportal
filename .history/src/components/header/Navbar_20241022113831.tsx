...
interface NavbarProps {
  isAdmin: boolean; // يمكن إزالة هذا الشرط إذا كنت تريد أن تكون القائمة مرئية للجميع
}
      ...
      <nav className={styles.navbar}>
        ...
        >
          <ul className={styles.navLinks}>
            ...
            >
              <Link onClick={() => setToggle(false)} href="/admin">Admin</Link>
              {/* Submenu for Admin */}
              {showAdminSubmenu && (
                <ul className={styles.submenu}>
                  ...
                  <li>
                    <Link onClick={() => setToggle(false)} href="/admin/articles">Articles</Link>
                  </li>
                  <li>
