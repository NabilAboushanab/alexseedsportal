...
const Navbar = ({ isAdmin }: NavbarProps) => {
  ...
  const handleToggle = () => setToggle(!toggle); // Toggle the menu
  const closeMenu = () => setToggle(false); // Close the menu
  ...
  return (
    <header className={styles.header}>
      <nav className={styles.navbar}>
        ...
        <div className={styles.menu} onClick={handleToggle} aria-label="Toggle menu">
        ...
        <div className={`${styles.navLinkWrapper} ${toggle ? styles.openMenu : ''}`}>
          <ul className={styles.navLinks}>
            ...
            <li>
              <Link onClick={closeMenu} className={styles.navLink} href="/articles?pageNumber=1">Articles</Link>
            </li>
            <li>
            ...
            >
              ...
              {showAdminSubmenu && (
                <ul className={styles.submenu}>
                  <li>
                    <Link onClick={closeMenu} href="/admin">Articles</Link>
                  </li>
                  <li>
                    <Link onClick={closeMenu} href="/admin/comments-table">Comments</Link>
                  </li>
                </ul>
              )}
            </li>
            ...
            >
              ...
              {showDepartmentsSubmenu && (
                <ul className={styles.submenu}>
                  ...
                  <li>
                    <Link onClick={closeMenu} href="/departments/sales-oil">Sales Oil</Link>
                  </li>
                </ul>
              )}
            </li>
